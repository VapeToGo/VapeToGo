...
async function loadMerchantsList() {
  ...
  try {
    ...
    const response = await fetch(`${SCRIPT_URL}?action=getMerchants&masterPassword=${encodeURIComponent(passwordInput)}`);
    const data = await response.json();
...
async function addNewMerchant(event) {
  ...
  try {
    const response = await fetch(`${SCRIPT_URL}?action=addMerchant&username=${encodeURIComponent(username)}&password=${encodeURIComponent(password)}&merchantName=${encodeURIComponent(merchantName)}`);
    const result = await response.json();
...
async function toggleMerchantHold(username) {
  ...
  try {
    const response = await fetch(`${SCRIPT_URL}?action=toggleMerchantStatus&username=${encodeURIComponent(username)}`);
    const result = await response.json();
    if (result.status === 'success') {
...
async function deleteMerchantAdmin(username) {
  ...
  try {
    const response = await fetch(`${SCRIPT_URL}?action=deleteMerchant&username=${encodeURIComponent(username)}`);
    const result = await response.json();
...
async function deleteProductAsAdmin(id) {
  ...
  try {
    const response = await fetch(`${SCRIPT_URL}?action=deleteProduct&id=${encodeURIComponent(id)}`);
    const result = await response.json();
    if (result.status === 'deleted') {
